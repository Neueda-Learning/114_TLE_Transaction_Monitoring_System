...
public class RandomTransactionGenerator {
     ...
     * Call this method from a scheduler or simulation service.
     *
     ...
     * Distribution:
     * <ul>
     *   <li>70 % — everyday amounts   : $1 – $500</li>
     *   <li>20 % — mid-range amounts  : $500 – $5,000</li>
     *   <li>8  % — large amounts      : $5,000 – $50,000</li>
     *   <li>2  % — suspicious amounts : $50,000 – $500,000 (triggers rules)</li>
     * </ul>
     */
    ...
    /**
     * Generates a payee ID in the format {@code PAY-<UUID prefix>} so it fits
     * within the {@code VARCHAR(50)} column defined in the schema.
     */
    ...
    /**
     * Returns a transaction timestamp within the last 24 hours to produce
     * realistic, recent data while still allowing time-window rule evaluation.
     */
